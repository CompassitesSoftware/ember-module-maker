...
EntryPointAssetGenerator.prototype.generate = function (callback) {
  ...
  // calculate the destination path, based on whether or not the module is an index module
  destPath = md.isIndexModule() ? fsh.join(this.destPath, 'index.html') :
    fsh.join(this.destPath, md.name, 'index.html');
